package dev.lone64.mslib.framework.builder.config.custom;

import dev.lone64.mslib.framework.builder.config.ConfigBuilderProvider;
import dev.lone64.mslib.framework.builder.config.custom.annotation.DeleteIfIncomplete;
import dev.lone64.mslib.framework.builder.config.custom.annotation.DeleteOnEmpty;
import dev.lone64.mslib.framework.builder.config.custom.processor.DeleteIfIncompleteProcessor;
import dev.lone64.mslib.framework.builder.config.custom.processor.DeleteOnEmptyProcessor;
import dev.lone64.mslib.framework.builder.config.custom.serializer.BigDecimalTypeSerializer;
import dev.lone64.mslib.framework.builder.config.custom.serializer.ItemStackTypeSerializer;
import dev.lone64.mslib.framework.builder.config.custom.serializer.LocationTypeSerializer;
import dev.lone64.mslib.framework.util.file.FileUtil;
