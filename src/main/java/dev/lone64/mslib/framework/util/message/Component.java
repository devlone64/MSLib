package dev.lone64.mslib.framework.util.message;

import dev.lone64.mslib.framework.MSPlugin;
import dev.lone64.mslib.framework.builder.config.ConfigBuilderProvider;
import dev.lone64.mslib.framework.builder.config.custom.CustomConfigBuilder;
import dev.lone64.mslib.framework.builder.config.yaml.YamlConfigBuilder;
import dev.lone64.mslib.framework.nms.NmsVersion;
import dev.lone64.mslib.framework.util.color.ColorUtil;
